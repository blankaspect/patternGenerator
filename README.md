...
This repository contains the source code and resources of the PatternGenerator application except for packages that are
...
Not all the classes of the `common` packages are required to build the PatternGenerator application.  The JAR file that
...
directory of the `patternGenerator` project:
```
..
|
+-- common
