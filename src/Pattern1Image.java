...
import uk.org.blankaspect.exception.ArgumentOutOfBoundsException;
import uk.org.blankaspect.exception.UnexpectedRuntimeException;

import uk.org.blankaspect.random.Prng01;

import uk.org.blankaspect.util.DoubleRange;
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private SaturationMode( String key )
        {
            this.key = key;
        }
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public static SaturationMode forKey( String key )
        {
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private RotationSense( String key )
        {
            this.key = key;
        }
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public static RotationSense forKey( String key )
        {
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private AnimationKind( String key )
        {
            this.key = key;
        }
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public static AnimationKind forKey( String key )
        {
        ...
        public static Set<AnimationKind> bitFieldToSet( int bitField )
        {
        ...
        public static int setToBitField( Set<AnimationKind> animationKinds )
        {
            int bitField = 0;
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public SourceParams( Source.Shape      shape,
        ...
        public SourceParams( String str )
        {
            int index = 0;
            ...
            switch ( shape )
            {
                ...
                case POLYGON:
                {
                    ...
                    if ( (numEdges < Source.Polygon.MIN_NUM_EDGES) ||
                         (numEdges > Source.Polygon.MAX_NUM_EDGES) )
                        throw new ArgumentOutOfBoundsException( );
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public Object getShapeParamValue( Key key )
        {
        ...
        {
            return new Color( Util.hsToRgb( (double)hue * INV_HUE_FACTOR,
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private static final    double  WAVE_TABLE_FACTOR_FIXED_PHASE
                                                                    = 2.0;
        private static final    double  INV_WAVE_TABLE_FACTOR_FIXED_PHASE
                                                                    = 1.0 / WAVE_TABLE_FACTOR_FIXED_PHASE;
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////
            ...
            {
                @Override
                protected Source createSource( Element element )
        ...
        ////////////////////////////////////////////////////////////////
            ...
            public static Shape forKey( String key )
            {
        ...
        ////////////////////////////////////////////////////////////////
            ...
            protected abstract Source createSource( Element element )
                throws XmlParseException;
        ...
        ////////////////////////////////////////////////////////////////
            ...
            public static Waveform forKey( String key )
            {
        ...
        ////////////////////////////////////////////////////////////////
            ...
            public static Constraint forKey( String key )
            {
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////
            ...
            private Circle( Waveform waveform,
                            int      waveCoeff )
            {
            ...
            private Circle( Element element )
                throws XmlParseException
            {
                super( element );
            }
        ...
        ////////////////////////////////////////////////////////////////
            ...
            @Override
            protected double getDistance( double x,
                                          double y )
            {
        ...
        ////////////////////////////////////////////////////////////////
            ...
            private Ellipse( Element element )
                throws XmlParseException
            {
                // Call superclass constructor
                super( element );
        ...
        ////////////////////////////////////////////////////////////////
            ...
            private Polygon( Element element )
                throws XmlParseException
            {
                // Call superclass constructor
                super( element );
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private static double attenuationCoeffIntToDouble( int coeff )
        {
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        protected abstract double getDistance( double x,
                                               double y );
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private Source copyModifyX( double x )
        {
            Source copy = clone( );
            copy.x = x;
        ...
        private Source copyModifyY( double y )
        {
            Source copy = clone( );
            copy.y = y;
        ...
        private Source copyModifyXY( double x,
                                     double y,
        ...
        private Source copyModifyXY1( double x,
                                      double y )
        {
        ...
        private Source copyModifyXY2( double x,
                                      double y )
        {
            Source copy = clone( );
            copy.x = x;
        ...
        private void updatePhaseOffset( int frameIndex )
        {
        ...
        private void updatePosition( int    frameIndex,
                                     int    width,
                                     int    height,
        ...
        private void updateOrientation( int frameIndex )
        {
        ...
        private double getWaveValue( double x,
                                     double y )
        {
        ...
        private void initWaveTable( double[] waveTable )
        {
        ...
        private void initWaveTable( int     width,
                                    int     height,
        ...
        private void initWaveTriangle( double  waveCoeff,
                                       boolean inverted )
        {
        ...
        private void initWaveCubic( double  waveCoeff,
                                    boolean inverted )
        {
        ...
        private void initWaveTableCosine( double  waveCoeff,
                                          boolean inverted )
        {
            final   double  FACTOR  = 2.0;
        ...
        private void initWaveTableModifiedCosine( double  waveCoeff,
                                                  boolean inverted )
        {
            double waveTableFactor = variablePhase ? 1.0 / (double)(waveTable.length - 1)
                                                   : INV_WAVE_TABLE_FACTOR_FIXED_PHASE;
        ...
        private void initWaveTableHyperbolicCosine( double  waveCoeff,
                                                    boolean inverted )
        {
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private BrightnessKey( Set<AnimationKind> animationKinds,
                               int                startFrameIndex )
        {
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private ImageRenderer( int          startY,
                               int          endY,
                               int          width,
                               List<Source> sources )
        {
...
////////////////////////////////////////////////////////////////////////
                          ...
                          Pattern1Params   params )
    {
        ...
        for ( SourceParams source : sourceParams )
        {
            ...
            int minWavelength = (int)StrictMath.round( d * wavelengthRange.lowerLimit );
            int maxWavelength = (int)StrictMath.round( d * wavelengthRange.upperLimit );
            ...
            double piLowerLimit = (double)phaseIncrementRange.lowerLimit;
            double piUpperLimit = (double)phaseIncrementRange.upperLimit;
            double phaseInc = piLowerLimit + prng2.nextDouble( piUpperLimit - piLowerLimit );
            ...
            double rr1 = 1.0 / rotationPeriodRange.lowerLimit;
            double rr2 = 1.0 / rotationPeriodRange.upperLimit;
...
////////////////////////////////////////////////////////////////////////
    ...
    public static Source createWaveTableSource( Source.Waveform waveform,
                                                int             waveCoeff,
                                                int             waveTableLength )
    {
    ...
    private static double denormalisePhaseIncrement( double value )
    {
...
////////////////////////////////////////////////////////////////////////
        ...
        throws InterruptedException
    {
        ...
        // Create image renderers, one per thread
        ImageRenderer[] renderers = new ImageRenderer[numRenderingThreads];
        ...
        for ( int i = 0; i < renderers.length; ++i )
        {
            ...
            renderers[i] = new ImageRenderer( y, y + height, regionWidth, sources );
            y += height;
        }
        ExecutorService executor = Executors.newFixedThreadPool( numRenderingThreads );
        ...
        if ( renderingMode == RenderingMode.TWO_PASSES )
        {
            // Convert each pixel's HSB values to RGB and set the RGB values in the buffer
            renderingDone = false;
            barrier.reset( );
            for ( ImageRenderer renderer : renderers )
                executor.submit( renderer );
...
////////////////////////////////////////////////////////////////////////
    ...
    public boolean isBrightnessRange( Set<AnimationKind> animationKinds,
                                      int                startFrameIndex )
    {
    ...
    public void removeBrightnessRange( Set<AnimationKind> animationKinds,
                                       int                startFrameIndex )
    {
    ...
    public void putBrightnessRange( Set<AnimationKind> animationKinds,
                                    int                startFrameIndex,
    ...
    public void initAnimation( Set<AnimationKind> animationKinds,
                               int                startFrameIndex )
    {
        ...
        else
        {
            ...
            else
            {
                ...
                minBrightness = brightnessRange.lowerLimit;
                maxBrightness = brightnessRange.upperLimit;
            }
        }
    }
    ...
    public void updateSourcePhases( int frameIndex )
    {
        for ( Source source : sources )
    ...
    public void updateSourceOrientations( int frameIndex )
    {
        for ( Source source : sources )
    ...
    private void renderImageA( int          startY,
                               int          endY,
                               int          regionWidth,
                               List<Source> sources )
        throws InterruptedException
        ...
        for ( int y = startY; y < endY; ++y )
        {
            ...
            for ( int x = 0; x < regionWidth; ++x )
            {
                ...
                for ( Source source : sources )
                {
                    ...
                    Util.hsToRgb( source.hue, source.saturation, rgbValuesB );
                    for ( int j = 0; j < rgbValuesA.length; ++j )
                        rgbValuesA[j] += rgbValuesB[j] * value;
                }
                Util.rgbToHs( rgbValuesA, hsValues );
    ...
    private void renderImageB( int startY,
                               int endY,
                               int regionWidth )
        throws InterruptedException
    {
