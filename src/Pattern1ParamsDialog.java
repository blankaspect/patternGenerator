...
import uk.org.blankaspect.gui.DoubleRangeBarPanel;
...
import uk.org.blankaspect.gui.RangeBarPanel;
...
////////////////////////////////////////////////////////////////////////
            ...
            if ( (column >= 0) && (column < Column.values( ).length) )
            {
                switch ( Column.values( )[column] )
                {
                    ...
                    case PARAMETER:
                    {
                        ...
                        return ( (key == null) ? new String( ) : source.getShapeParamValue( key ) );
                    }
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        protected void paintComponent( Graphics gr )
        {
            ...
            gr.drawString( text, x, GuiUtilities.getBaselineOffset( height, fontMetrics ) );
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public boolean isCellEditable( EventObject event )
        {
            ...
            if ( event instanceof KeyEvent )
            {
                ...
                int modifiers = ((KeyEvent)event).getModifiersEx( );
...
////////////////////////////////////////////////////////////////////////
    ...
    public static Pattern1Params showDialog( Component      parent,
                                             ...
                                             Pattern1Params params )
    {
        return new Pattern1ParamsDialog( GuiUtilities.getWindow( parent ), titleStr, params ).getParams( );
    }
