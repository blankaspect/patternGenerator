...
////////////////////////////////////////////////////////////////////////
                           ...
                           PatternDocument document )
    {
        ...
        GuiUtilities.setPaddedLineBorder( buttonPanel, BUTTON_PANEL_VERTICAL_MARGIN,
        ...
        if ( AppConfig.getInstance( ).isKeepSequenceWindowOnTop( ) )
            setAlwaysOnTop( true );

        // Set location of dialog box
        if ( location == null )
            location = App.getInstance( ).getView( ).getViewportLocation( );
...
////////////////////////////////////////////////////////////////////////
    ...
    private void setPaused( boolean paused )
    {
        ...
        if ( paused )
        {
            if ( frameIndexPopUp == null )
            {
                ...
                frameIndexPopUp = PopupFactory.getSharedInstance( ).getPopup( this, component, location.x,
                                                                              location.y );
    ...
    {
        Command.CREATE_DOCUMENT.setEnabled( paused && !App.getInstance( ).isDocumentsFull( ) );
    }
    ...
    private void onCreateDocument( )
    {
        try
        {
            if ( !App.getInstance( ).isDocumentsFull( ) )
            {
                PatternDocument newDocument = document.createDefinitionDocument( false );
                App.getInstance( ).addDocument( newDocument );
                String str = StringUtilities.substitute( DOCUMENT_CREATED_STR,
