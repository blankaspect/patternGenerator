...
////////////////////////////////////////////////////////////////////////
	...
	private JPanel createPanelPattern()
	{
		...
		for (PatternKind patternKind : PatternKind.values())
		{
			...
			DimensionsSpinnerPanel defaultSizePanel = new DimensionsSpinnerPanel(size.width, widthRange.lowerBound,
																				 widthRange.upperBound,
																				 DEFAULT_PATTERN_WIDTH_FIELD_LENGTH,
																				 size.height, heightRange.lowerBound,
																				 heightRange.upperBound,
			...
			FIntegerSpinner numSlideShowThreadsSpinner = new FIntegerSpinner(config.getNumSlideShowThreads(patternKind),
