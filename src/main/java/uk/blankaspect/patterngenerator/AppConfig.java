...
////////////////////////////////////////////////////////////////////////
	...
	private static final	String	PROPERTIES_FILENAME	= PatternGeneratorApp.NAME_KEY + "-properties"
															+ AppConstants.XML_FILENAME_EXTENSION;
	private static final	String	FILENAME_STEM		= PatternGeneratorApp.NAME_KEY + "-config";
	...
	private interface Key
	{
		...
		String	CONFIGURATION					= PatternGeneratorApp.NAME_KEY + "Configuration";
...
////////////////////////////////////////////////////////////////////////
	...
	{
		PatternGeneratorApp.INSTANCE
				.showWarningMessage(PatternGeneratorApp.SHORT_NAME + " : " + CONFIGURATION_ERROR_STR, exception);
	}
	...
	{
		PatternGeneratorApp.INSTANCE
				.showErrorMessage(PatternGeneratorApp.SHORT_NAME + " : " + CONFIGURATION_ERROR_STR, exception);
	}
...
//--////////////////////////////////////////////////////////////////////
	...
	{
		return new File(PathnameUtils.parsePathname(getOpenPatternPathname()));
	}
...
//--////////////////////////////////////////////////////////////////////
	...
	{
		return new File(PathnameUtils.parsePathname(getSavePatternPathname()));
	}
...
//--////////////////////////////////////////////////////////////////////
	...
	{
		return new File(PathnameUtils.parsePathname(getExportImagePathname()));
	}
...
//--////////////////////////////////////////////////////////////////////
	...
	{
		return new File(PathnameUtils.parsePathname(getExportSvgPathname()));
	}
...
//--////////////////////////////////////////////////////////////////////
	...
	{
		return new File(PathnameUtils.parsePathname(getExportImageSequencePathname()));
	}
