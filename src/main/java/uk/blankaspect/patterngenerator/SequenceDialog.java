...
////////////////////////////////////////////////////////////////////////
						  ...
						  PatternDocument document)
	{
		...
		if (location == null)
			location = App.INSTANCE.getView().getViewportLocation();
...
////////////////////////////////////////////////////////////////////////
	...
	{
		Command.CREATE_DOCUMENT.setEnabled(paused && !App.INSTANCE.isDocumentsFull());
	}
	...
	private void onCreateDocument()
	{
		try
		{
			if (!App.INSTANCE.isDocumentsFull())
			{
