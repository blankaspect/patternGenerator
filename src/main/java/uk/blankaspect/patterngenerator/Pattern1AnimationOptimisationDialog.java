...
////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////
		...
		private static final	KeyAction.KeyCommandPair[]	KEY_COMMANDS	=
		{
			...
			KeyAction.command(KeyStroke.getKeyStroke(KeyEvent.VK_TAB, 0),
							  Command.FOCUS_NEXT),
			KeyAction.command(KeyStroke.getKeyStroke(KeyEvent.VK_A, KeyEvent.CTRL_DOWN_MASK),
							  Command.SELECT_ALL)
		};
	...
	////////////////////////////////////////////////////////////////////
		...
		private MapKeyTable(AbstractTableModel tableModel)
		{
			...
			int rowHeight = 2 * CELL_VERTICAL_MARGIN + GRID_LINE_WIDTH + getFontMetrics(getFont()).getHeight();
	...
	////////////////////////////////////////////////////////////////////
		...
		public void actionPerformed(ActionEvent event)
		{
			switch (event.getActionCommand())
			{
				...
				case Command.SELECT_ALL     -> onSelectAll();
			}
		}
	...
	////////////////////////////////////////////////////////////////////
		...
		public Dimension getPreferredSize()
		{
			int width = 2 * MapKeyTable.CELL_HORIZONTAL_MARGIN + MapKeyTable.GRID_LINE_WIDTH + MARKER_WIDTH
							+ 2 * MARKER_MARGIN;
			int height = 2 * MapKeyTable.CELL_VERTICAL_MARGIN + MapKeyTable.GRID_LINE_WIDTH + MARKER_HEIGHT
							+ 2 * MARKER_MARGIN;
			return new Dimension(width, height);
		}
		...
		protected void paintComponent(Graphics gr)
		{
			...
			if (value)
			{
				...
				gr2d.drawImage(MARKER_IMAGE, x, y, null);
			}
