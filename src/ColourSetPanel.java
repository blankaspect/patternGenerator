...
////////////////////////////////////////////////////////////////////////
    ...
    private static final    String  GRADATE_STR             = "Gradate";
    ...
    private static final    String  GRADATE_TITLE_STR       = "Gradate selected colours";
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private static final    Color   HIGHLIGHTED_BACKGROUND_COLOUR
    ...
    ////////////////////////////////////////////////////////////////////
                                          ...
                                          HueSaturationRangePanel.Params params )
        {
            ...
            GuiUtilities.setPaddedLineBorder( hueSaturationRangePanel, 2, 2, 6, 2 );
            ...
            KeyAction.create( mainPanel, JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT, this,
                              KEY_COMMANDS );
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        protected void paintComponent( Graphics gr )
        {
            ...
            gr.setColor( isEnabled( ) ? (buttonState == ButtonState.ARMED)
                                                                ? ColourUtilities.invert( getForeground( ) )
                                                                : getForeground( )
                                      : getBackground( ) );
            ...
            if ( !isEnabled( ) )
            {
                ...
                gr2d.setRenderingHint( RenderingHints.KEY_STROKE_CONTROL,
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            Color colour = JColorChooser.showDialog( this, COLOUR_STR + (index + 1), getForeground( ) );
            if ( colour != null )
                setForeground( colour );
        }
...
////////////////////////////////////////////////////////////////////////
                           ...
                           Color       defaultColour )
    {
        ...
        int numRows = NumberUtilities.roundUpQuotientInt( maxNumColours, NUM_COLUMNS );
        ...
        for ( int i = 0; i < numRows; ++i )
        {
            ...
            for ( int j = 0; j < NUM_COLUMNS; ++j )
            {
                ...
                {
                    ColourButton button = new ColourButton( index,
                                                            (index < numColours) ? colours.get( index )
                                                                                 : defaultColour );
                    ...
                    rowColourButtonPanel.add( GuiUtilities.createFiller( ) );
            }
        ...
        // Button: gradate
        gradateButton = new FButton( GRADATE_STR + AppConstants.ELLIPSIS_STR );
        gradateButton.setMargin( BUTTON_MARGINS );
        gradateButton.setActionCommand( Command.GRADATE );
        gradateButton.addActionListener( this );
        buttonPanel.add( gradateButton );
...
////////////////////////////////////////////////////////////////////////
    ...
    public void actionPerformed( ActionEvent event )
    {
        ...
        if ( command.startsWith( Command.SELECT_ALL_IN_ROW ) )
            onSelectAllInRow( StringUtilities.removePrefix( command, Command.SELECT_ALL_IN_ROW ) );

        else if ( command.equals( Command.SET ) )
            onSet( );

        else if ( command.equals( Command.GRADATE ) )
            onGradate( );
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        return ( (index < numColours) ? colourButtons.get( index ).getForeground( ) : null );
    }
    ...
    public void setNumColours( int numColours )
    {
        if ( this.numColours != numColours )
        {
            ...
            else if ( numColours > this.numColours )
            {
                ...
                {
                    ColourButton button = colourButtons.get( i );
                    button.setForeground( defaultColour );
    ...
    {
        int numRows = NumberUtilities.roundUpQuotientInt( numColours, NUM_COLUMNS );
        ...
        gradateButton.setEnabled( numSelected > 1 );
    ...
    private void onGradate( )
    {
        HueSaturationRangeDialog dialog =
                                    new HueSaturationRangeDialog( SwingUtilities.getWindowAncestor( this ),
                                                                  GRADATE_TITLE_STR, gradateParams );
        if ( dialog.accepted )
        {
            HueSaturationRangePanel.Params params = dialog.hueSaturationRangePanel.getParams( );
            gradateParams = params;
            int hue2 = params.hue2;
            if ( hue2 < params.hue1 )
                hue2 += HueSaturationRangePanel.HUE_RANGE;
            IntegerRange hueRange = new IntegerRange( params.hue1, hue2 );
            IntegerRange satRange = new IntegerRange( params.saturation1, params.saturation2 );
            ...
            for ( int i = 0; i < buttons.size( ); ++i )
            {
                ...
                Color colour = HueSaturationRangePanel.hsbToColour( hueRange.getValue( fraction ),
                                                                    satRange.getValue( fraction ),
                                                                    params.brightness );
                buttons.get( i ).setForeground( colour );
            }
        }
    }
    ...
    private void onRandomise( )
    {
        ...
        if ( dialog.accepted )
        {
            ...
            if ( hue2 < params.hue1 )
                hue2 += HueSaturationRangePanel.HUE_RANGE;
            IntegerRange hueRange = new IntegerRange( params.hue1, hue2 );
            IntegerRange satRange = new IntegerRange( Math.min( params.saturation1, params.saturation2 ),
...
////////////////////////////////////////////////////////////////////////
    ...
    private static  Prng01                          prng            =
                                        new Prng01( App.getInstance( ).getNextRandomSeed( ) );
    private static  Stroke                          dash            =
                                        new BasicStroke( 1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER,
                                                         10.0f, new float[]{ 2.0f, 2.0f }, 0.5f );
    private static  HueSaturationRangePanel.Params  gradateParams   = new HueSaturationRangePanel.Params( );
