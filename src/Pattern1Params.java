...
////////////////////////////////////////////////////////////////////////
    ...
    public static final Pattern1Image.SaturationMode    DEFAULT_SATURATION_MODE =
                                                                    Pattern1Image.SaturationMode.VARIABLE;
    ...
    public static final Pattern1Image.RotationSense DEFAULT_ROTATION_SENSE  =
                                                                            Pattern1Image.RotationSense.ANY;
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            return ( AppConstants.FORMAT_1_8.format( value.lowerLimit ) + ", " +
                                                    AppConstants.FORMAT_1_8.format( value.upperLimit ) );
        }
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
                              ...
                              int   index )
        {
            ...
            {
                App.getInstance( ).showWarningMessage( App.SHORT_NAME, e );
            }
        }
...
////////////////////////////////////////////////////////////////////////
                           ...
                           Long                             seed )
    {
        ...
        if ( (width < MIN_WIDTH) || (width > MAX_WIDTH) ||
             ...
             (symmetry == null) ||
             (saturationMode == null) ||
             (wavelengthRange.lowerLimit < MIN_WAVELENGTH) ||
             (wavelengthRange.upperLimit > MAX_WAVELENGTH) ||
             (wavelengthRange.lowerLimit > wavelengthRange.upperLimit) ||
             ListUtilities.isNullOrEmpty( sources ) ||
             (motionRateRange.lowerLimit < Pattern1Image.MIN_MOTION_RATE) ||
             (motionRateRange.upperLimit > Pattern1Image.MAX_MOTION_RATE) ||
             (motionRateRange.lowerLimit > motionRateRange.upperLimit) ||
             (phaseIncrementRange.lowerLimit < Pattern1Image.MIN_PHASE_INCREMENT) ||
             (phaseIncrementRange.upperLimit > Pattern1Image.MAX_PHASE_INCREMENT) ||
             (phaseIncrementRange.lowerLimit > phaseIncrementRange.upperLimit) ||
             (rotationPeriodRange.lowerLimit < MIN_ROTATION_PERIOD) ||
             (rotationPeriodRange.upperLimit > MAX_ROTATION_PERIOD) ||
             (rotationPeriodRange.lowerLimit > rotationPeriodRange.upperLimit) ||
             (rotationSense == null) ||
