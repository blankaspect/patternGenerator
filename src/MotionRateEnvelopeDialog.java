...
import uk.org.blankaspect.envelope.EnvelopeNodeValueDialog;
import uk.org.blankaspect.envelope.EnvelopeScrollPane;
...
import uk.org.blankaspect.textfield.DoubleValueField;
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private NodeValueField( )
        {
            ...
            GuiUtilities.setTextComponentMargins( this, VERTICAL_MARGIN, HORIZONTAL_MARGIN );
            setEditable( false );
            setFocusable( false );
        }
    ...
    public static class NodeXSpinner
        ...
        implements EnvelopeNodeValueDialog.NodeValueEditor
    {
    ...
    ////////////////////////////////////////////////////////////////////
    //  Instance methods : NodeValueEditor interface
    ////////////////////////////////////////////////////////////////////
    ...
    private static class EnvelopeView
        extends uk.org.blankaspect.envelope.EnvelopeView
    {
...
////////////////////////////////////////////////////////////////////////
    ...
    public static MotionRateEnvelope showDialog( Component          parent,
                                                 MotionRateEnvelope envelope )
    {
        return new MotionRateEnvelopeDialog( GuiUtilities.getWindow( parent ), envelope ).getEnvelope( );
    }
...
////////////////////////////////////////////////////////////////////////
        ...
        throws AppException
    {
        ...
        {
            GuiUtilities.setFocus( xCoeffField );
            throw e;
        }
        ...
        {
            GuiUtilities.setFocus( yCoeffField );
            throw e;
        }
    }
