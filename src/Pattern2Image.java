...
////////////////////////////////////////////////////////////////////////
    ...
    public static final     IntegerRange    DEFAULT_TRANSITION_INTERVAL_RANGE   =
                                                                                new IntegerRange( 50, 75 );
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////
            ...
            private static LengthComparator getInstance( )
            {
                if ( instance == null )
        ...
        ////////////////////////////////////////////////////////////////
                                ...
                                Path path2 )
            {
                ...
                int result = path1.getLength( ) - path2.getLength( );

                // If lengths are equal, compare times of last lengthening: most recent is first
                if ( result == 0 )
                    result = StrictMath.max( path2.start.lengthenFrameIndex,
    ...
    ////////////////////////////////////////////////////////////////////
            ...
            throws XmlParseException
        {
            ...
            try
            {
                colour = ColourUtilities.parseColour( attrValue );
            }
                    ...
                    if ( element1.getTagName( ).equals( ElementName.DIRECTION ) )
                    {
                        ...
                        if ( direction == null )
                            throw new XmlParseException( ErrorId.INVALID_DIRECTION,
                                                         XmlUtilities.getElementPath( element1 ), str );
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private List<Attribute> getAttributes( )
        {
            ...
            attributes.add( new Attribute( AttrName.COLOUR, ColourUtilities.colourToRgbString( colour ) ) );
            return attributes;
        }
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////
                ...
                throws IOException
            {
                ...
                char[] spaces = StringUtilities.createCharArray( ' ', numSpaces );
                ...
                List<Attribute> attributes = new ArrayList<>( );
                attributes.add( new Attribute( Svg.AttrName.STROKE,
                                               ColourUtilities.colourToHexString( colour ) ) );
...
////////////////////////////////////////////////////////////////////////
        ...
        throws XmlParseException
    {
        ...
        try
        {
            backgroundColour = ColourUtilities.parseColour( attrValue );
        }
        catch ( IllegalArgumentException e )
        {
            throw new XmlParseException( ErrorId.INVALID_ATTRIBUTE, attrKey, attrValue );
        ...
        throws InterruptedException
    {
        ...
        Collections.sort( paths, Path.LengthComparator.getInstance( ) );
...
////////////////////////////////////////////////////////////////////////
    ...
    private static Map<Direction, Double> getCumulativeProbabilities(
                                                                    Map<Direction, Integer> probabilities )
    {
...
////////////////////////////////////////////////////////////////////////
    ...
    public Pattern2Image clone( )
    {
        try
        {
            ...
            copy.backgroundColour = new Color( backgroundColour.getRGB( ) );

            copy.pathColours = new ArrayList<>( );
            for ( Color colour : pathColours )
                copy.pathColours.add( new Color( colour.getRGB( ) ) );
        ...
        throws InterruptedException
    {
        ...
        gr.setRenderingHint( RenderingHints.KEY_STROKE_CONTROL,
                             AppConfig.getInstance( ).getPattern2PathRendering( ).renderingHintValue );

        gr.setStroke( new BasicStroke( (float)pathThickness, BasicStroke.CAP_ROUND,
...
////////////////////////////////////////////////////////////////////////
        ...
        throws IOException
    {
        ...
        writer.write( ' ' );
        writer.write( App.getInstance( ).getVersionString( ) );
        ...
        for ( String str : PATH_STYLE_STRS )
        {
            ...
            writer.write( StringUtilities.substitute( str, OutputShape.FORMAT.format( pathThickness ) ) );
            writer.writeEol( );
        }
        ...
        attributes.clear( );
        attributes.add( new Attribute( Svg.AttrName.FILL,
                                       ColourUtilities.colourToHexString( backgroundColour ) ) );
        attributes.add( new Attribute( Svg.AttrName.WIDTH, width ) );
        attributes.add( new Attribute( Svg.AttrName.HEIGHT, height ) );
        writer.writeEmptyElement( Svg.ElementName.RECT, attributes, indent, true );
        ...
        throws InterruptedException
    {
        ...
        // Sort the paths by increasing length
        Collections.sort( candidatePaths, Path.LengthComparator.getInstance( ) );
        ...
        while ( !candidatePaths.isEmpty( ) )
        {
            ...
            while ( path == null )
            {
                double exp = prngGeneral.nextExponential( EXPONENTIAL_DIST_LAMBDA ) *
                                                                                    EXPONENTIAL_DIST_FACTOR;
            ...
            switch ( change )
            {
                ...
                case 3:
                    terminalKind = prngGeneral.nextBoolean( ) ? Path.Terminal.Kind.START
                                                              : Path.Terminal.Kind.END;
                    break;
            }
            ...
            for ( Direction direction : probabilities.keySet( ) )
            {
                ...
                else
                {
                    ...
                    {
                        if ( (path1 != path) &&
                             (path1.start.change != Path.Change.SHORTEN) &&
            ...
            if ( direction == null )
            {
                      ...
                      ((path.end.i1 == 0) && (path.start.i1 == numIndices1 - 1))) )
                {
                    ...
                    newPath.start.shorten( frameIndex, getTransitionLength( ),
                                           newPath.getFirstDirection( ) );
                    ++numActivePaths;
                }
                ...
                else if ( !path.isEmpty( ) )
                {
                    ...
                    {
                        direction = (terminalKind == Path.Terminal.Kind.START)
    ...
    private List<Attribute> getAttributes( )
    {
        ...
        attributes.add( new Attribute( AttrName.TERMINAL_DIAMETER, terminalDiameter,
                                       AppConstants.FORMAT_1_8 ) );
        attributes.add( new Attribute( AttrName.SHOW_EMPTY_PATHS, showEmptyPaths ) );
        attributes.add( new Attribute( AttrName.BACKGROUND_COLOUR,
                                       ColourUtilities.colourToRgbString( backgroundColour ) ) );
    ...
    {
        return ( transitionIntervalRange.lowerLimit +
    ...
    private Map<Direction, Double> getCumulativeRelativeInverseProbabilities( Direction baseDirection )
    {
        ...
        Map<Direction, Double> cumulativeProbabilities =
                                        cumulativeRelativeInverseProbabilitiesCache.get( baseDirection );
            ...
            for ( Path path : paths )
            {
                ...
                if ( path.isEmpty( ) )
                {
                    ...
                    switch ( path.start.change )
                    {
                        ...
                        case LENGTHEN:
                            colour = ColourUtilities.interpolate( backgroundColour, path.colour,
                                                                  (float)path.start.changeFraction );
                            break;

                        case SHORTEN:
                            colour = ColourUtilities.interpolate( path.colour, backgroundColour,
                                                                  (float)path.start.changeFraction );
                            break;
                    }
