...
////////////////////////////////////////////////////////////////////////
                               ...
                               String description )
    {
        ...
        // Label: description
        JLabel descriptionLabel = new FLabel( DESCRIPTION_STR );
        ...
        gridBag.setConstraints( descriptionLabel, gbc );
        controlPanel.add( descriptionLabel );

        // Field: description
        descriptionField = new FTextField( description, DESCRIPTION_FIELD_NUM_COLUMNS );
        ...
        gbc.fill = GridBagConstraints.NONE;
        gbc.insets = AppConstants.COMPONENT_INSETS;
        gridBag.setConstraints( descriptionField, gbc );
...
////////////////////////////////////////////////////////////////////////
    ...
    public static String showDialog( Component parent,
                                     ...
                                     String    text )
    {
        return new DescriptionDialog( GuiUtilities.getWindow( parent ), titleStr, text ).getDescription( );
    }
