...
import uk.org.blankaspect.gui.SpinnerSliderPanel;
...
////////////////////////////////////////////////////////////////////////
                                  ...
                                  Pattern1Image.SourceParams params )
    {
        ...
        GuiUtilities.setPaddedLineBorder( shapePanel );
        ...
        GuiUtilities.setPaddedLineBorder( wavePanel );
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        return new Pattern1SourceDialog( GuiUtilities.getWindow( parent ), index, source ).getParams( );
    }
