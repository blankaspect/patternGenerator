...
////////////////////////////////////////////////////////////////////////
    ...
    public static final Pattern2Image.Direction.Mode    DEFAULT_DIRECTION_MODE  =
...
//--////////////////////////////////////////////////////////////////////
    ...
    {
        ppBackgroundColour.setValue( value );
    }
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            return ColourUtilities.colourToRgbString( values.get( index ) );
        }
...
////////////////////////////////////////////////////////////////////////
                           ...
                           Long                                  seed )
    {
        ...
        if ( (width < MIN_WIDTH) || (width > MAX_WIDTH) ||
             ...
             ListUtilities.isNullOrEmpty( pathColours ) ||
             (activeFraction < Pattern2Image.MIN_ACTIVE_FRACTION) ||
                                                    (activeFraction > Pattern2Image.MAX_ACTIVE_FRACTION) ||
             (transitionIntervalRange.lowerLimit < Pattern2Image.MIN_TRANSITION_INTERVAL) ||
             (transitionIntervalRange.upperLimit > Pattern2Image.MAX_TRANSITION_INTERVAL) ||
             (transitionIntervalRange.lowerLimit > transitionIntervalRange.upperLimit) ||
...
////////////////////////////////////////////////////////////////////////
    ...
    public Pattern2Params clone( )
    {
        ...
        for ( Color colour : getPathColours( ) )
            pathColours.add( new Color( colour.getRGB( ) ) );
        Long seed = getSeed( );
        if ( seed != null )
            seed = seed.longValue( );
        return new Pattern2Params( getWidth( ), getHeight( ), getOrientation( ), getEndMargin( ),
                                   getSideMargin( ), getGridInterval( ), getPathThickness( ),
                                   getTerminalDiameter( ), getExpectedPathLength( ),
                                   getDirectionProbabilities( ), getDirectionMode( ),
                                   getTerminalEmphasis( ), isShowEmptyPaths( ),
                                   new Color( getBackgroundColour( ).getRGB( ) ), pathColours,
