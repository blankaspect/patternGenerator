...
////////////////////////////////////////////////////////////////////////
    ...
    private static final    int FILENAME_BASE_FIELD_LENGTH  = 24;
    ...
    private static final    String  FILENAME_BASE_STR       = "Filename base:";
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        NO_FILENAME_BASE
        ( "No filename base was specified." );
...
////////////////////////////////////////////////////////////////////////
                                       ...
                                       ImageSequenceParams params )
    {
        ...
        // Label: filename base
        JLabel filenameBaseLabel = new FLabel( FILENAME_BASE_STR );
        ...
        gbc.fill = GridBagConstraints.NONE;
        gbc.insets = AppConstants.COMPONENT_INSETS;
        gridBag.setConstraints( filenameBaseLabel, gbc );
        controlPanel.add( filenameBaseLabel );

        // Field: filename base
        filenameBaseField = new FTextField( params.filenameBase, FILENAME_BASE_FIELD_LENGTH );
        ...
        gbc.fill = GridBagConstraints.NONE;
        gbc.insets = AppConstants.COMPONENT_INSETS;
        gridBag.setConstraints( filenameBaseField, gbc );
        controlPanel.add( filenameBaseField );
...
////////////////////////////////////////////////////////////////////////
    ...
    public static ImageSequenceParams showDialog( Component           parent,
                                                  ...
                                                  ImageSequenceParams params )
    {
        return new ExportImageSequenceDialog( GuiUtilities.getWindow( parent ), imageWidth, imageHeight,
...
////////////////////////////////////////////////////////////////////////
        ...
        throws AppException
    {
        ...
        {
            GuiUtilities.setFocus( directoryField );
            throw e;
        }
        ...
        try
        {
            if ( filenameBaseField.isEmpty( ) )
                throw new AppException( ErrorId.NO_FILENAME_BASE );
        }
        catch ( AppException e )
        {
            GuiUtilities.setFocus( filenameBaseField );
            throw e;
        }
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    static
    {
        ...
        directoryChooser.setSelectedFile( AppConfig.getInstance( ).getExportImageSequenceDirectory( ) );
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    private FTextField              filenameBaseField;
