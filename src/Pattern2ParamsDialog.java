...
import uk.org.blankaspect.gui.DoubleSpinnerSliderPanel;
...
import uk.org.blankaspect.gui.IntegerRangeBarPanel;
...
////////////////////////////////////////////////////////////////////////
    ...
    private static final    String  TITLE_STR                   = PatternKind.PATTERN2.getName( ) +
                                                                                        " parameters | ";
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private SpinnerSliderPanel( double       value,
                                    ...
                                    double       defaultValue )
        {
            super( value, minValue, maxValue, deltaValue, fieldLength, format, false, sliderWidth,
                   SLIDER_HEIGHT, SLIDER_KNOB_WIDTH, defaultValue, SPINNER_SLIDER_PANEL_KEY );
        }
...
////////////////////////////////////////////////////////////////////////
                                  ...
                                  Pattern2Params params )
    {
        ...
        // Panel: size
        sizePanel = new DimensionsSpinnerPanel( params.getWidth( ), Pattern2Params.MIN_WIDTH,
                                                Pattern2Params.MAX_WIDTH, WIDTH_FIELD_LENGTH,
                                                params.getHeight( ), Pattern2Params.MIN_HEIGHT,
        ...
        int sliderExtent = (int)Math.round( Pattern2Params.MAX_GRID_INTERVAL -
                                                                        Pattern2Params.MIN_GRID_INTERVAL );
        int sliderWidth = HorizontalSlider.extentToWidth( sliderExtent, SLIDER_KNOB_WIDTH );

        gridIntervalSpinnerSlider = new SpinnerSliderPanel( params.getGridInterval( ),
                                                            Pattern2Params.MIN_GRID_INTERVAL,
                                                            Pattern2Params.MAX_GRID_INTERVAL,
                                                            DELTA_GRID_INTERVAL, GRID_INTERVAL_FIELD_LENGTH,
                                                            AppConstants.FORMAT_1_2, sliderWidth,
                                                            Pattern2Params.DEFAULT_GRID_INTERVAL );
        ...
        sliderExtent = (int)Math.round( Pattern2Params.MAX_PATH_THICKNESS -
        ...
        pathThicknessSpinnerSlider = new SpinnerSliderPanel( params.getPathThickness( ),
                                                             Pattern2Params.MIN_PATH_THICKNESS,
                                                             Pattern2Params.MAX_PATH_THICKNESS,
                                                             DELTA_PATH_THICKNESS,
                                                             PATH_THICKNESS_FIELD_LENGTH,
                                                             AppConstants.FORMAT_1_2, sliderWidth,
                                                             Pattern2Params.DEFAULT_PATH_THICKNESS );
        ...
        sliderExtent = (int)Math.round( Pattern2Params.MAX_TERMINAL_DIAMETER -
        ...
        terminalDiameterSpinnerSlider = new SpinnerSliderPanel( params.getTerminalDiameter( ),
                                                                ...
                                                                DELTA_TERMINAL_DIAMETER,
                                                                TERMINAL_DIAMETER_FIELD_LENGTH,
                                                                AppConstants.FORMAT_1_2, sliderWidth,
        ...
        backgroundColourButton = new ColourButton( params.getBackgroundColour( ) );
        ...
        numPathColoursSpinner = new FIntegerSpinner( colours.size( ), Pattern2Params.MIN_NUM_PATH_COLOURS,
                                                     Pattern2Params.MAX_NUM_PATH_COLOURS,
                                                     NUM_PATH_COLOURS_FIELD_LENGTH );
        ...
        pathColourPanel = new ColourSetPanel( Pattern2Params.MAX_NUM_PATH_COLOURS, colours,
                                              Pattern2Params.DEFAULT_PATH_COLOUR );
        ...
        activeFractionSpinner = new FIntegerSpinner( params.getActiveFraction( ),
                                                     Pattern2Image.MIN_ACTIVE_FRACTION,
                                                     Pattern2Image.MAX_ACTIVE_FRACTION,
                                                     ACTIVE_FRACTION_FIELD_LENGTH );
...
////////////////////////////////////////////////////////////////////////
    ...
    public static Pattern2Params showDialog( Component      parent,
                                             ...
                                             Pattern2Params params )
    {
        return new Pattern2ParamsDialog( GuiUtilities.getWindow( parent ), titleStr, params ).getParams( );
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        GuiUtilities.setAllEnabled( terminalDiameterSpinnerSlider,
                                    terminalEmphasisComboBox.getSelectedValue( ) !=
                                                                    Pattern2Image.TerminalEmphasis.NONE );
    }
    ...
    private void updateDirectionProbabilitySpinners( )
    {
        directionProbabilitySpinners.get( Pattern2Image.Direction.BACK ).
            setEnabled( directionModeComboBox.getSelectedValue( ) ==
                                                                    Pattern2Image.Direction.Mode.ABSOLUTE );
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    private JCheckBox                                       showEmptyPathsCheckBox;
