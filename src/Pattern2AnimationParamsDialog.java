...
import uk.org.blankaspect.gui.UnsignedIntegerComboBox;
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        return new Pattern2AnimationParamsDialog( GuiUtilities.getWindow( parent ) ).getAnimationParams( );
    }
...
////////////////////////////////////////////////////////////////////////
        ...
        throws AppException
    {
        ...
        {
            GuiUtilities.setFocus( startFrameComboBox );
    ...
    private void onAccept( )
    {
        try
        {
            ...
            AppConfig.getInstance( ).setAnimationRate( rate );
...
////////////////////////////////////////////////////////////////////////
    ...
    private static  double          rate                = AppConfig.getInstance( ).getAnimationRate( );
